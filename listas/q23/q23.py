...
# em disco no seu servidor de arquivos. Para tentar resolver este problema,
...
# feita através de uma função separada, que será chamada pelo programa
...
with open('relatorio.txt', mode='w') as dado:
    ...
    for itera in range(len(usuarios)):
        ...
        dado.write(
            f'{itera + 1:<6}{usuarios[itera]:<15} {tamanho_uso:>12.2f} MB '
